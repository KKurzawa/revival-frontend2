...
const Footer = () => {
    ...
    return (
        <footer className='footer-container flex flex-col w-full items-center h-auto py-3 text-[whitesmoke]'>
            ...
            <p className='py-[.15rem] text-[.6rem] md:text-xl'>Copyright &copy; {today.getFullYear()} Revival Band Detroit - All Rights Reserved</p>
            <button onClick={() => setTimeout(() => window.open('https://www.kriskurzawadev.com/', '_blank'), 500)} className='mb-1 py-[.15rem] text-[.6rem] md:text-xl'>Site Designed and Built by Kris Kurzawa</button>
        </footer>
    )
}
