...
const Video = () => {
    return (
        <main id='videos' className='flex flex-col items-center w-full text-[whitesmoke]'>
            <header className='video-header py-2 md:py-5 w-full text-center'><span className='text-[2rem]'>V</span><span className='text-3xl'>IDEO</span><span className='text-[2rem]'>S</span></header>
